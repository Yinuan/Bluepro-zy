...
import com.klcxkj.zqxy.deco.result.ISBNResult;
import com.klcxkj.zqxy.deco.result.ProductResult;
import com.klcxkj.zqxy.zxing.BasicActivity;
import com.klcxkj.zqxy.zxing.entities.Barcode;
    ...
    private void executeAsync(LiteHttp liteHttp, String productID) {
        ...
        StringRequest stringRequest = new StringRequest("http://apis.baidu.com/3023/barcode/barcode")
                ...
                .setHttpListener(new HttpListener<String>() {
                    ...
                    @Override
                    public void onFailure(com.litesuits.http.exception.HttpException e, Response<String> response) {
